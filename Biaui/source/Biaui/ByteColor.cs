...
namespace Biaui
{
    ...
    public struct ByteColor : IEquatable<ByteColor>
    {
        ...
        public string Argb
        {
            set => _argb = int.Parse(value, NumberStyles.HexNumber);
        }
        ...
        private sealed class ImmutableByteColorEqualityComparer : IEqualityComparer<ByteColor>
        {
            public bool Equals(ByteColor x, ByteColor y) => x._argb == y._argb;
            public int GetHashCode(ByteColor obj) => obj._argb;
        }

        public static IEqualityComparer<ByteColor> ImmutableByteColorComparer { get; } = new ImmutableByteColorEqualityComparer();
    ...
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static ByteColor ToImmutableByteColor(this Color src)
